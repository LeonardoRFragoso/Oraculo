import { MessageSquare, BarChart3, Upload, Trash2, Plus, Database, Bell, Share2, Cpu, History, Shield, Zap } from 'lucide-react'
...
export default function Sidebar() {
  ...
  const navItems = [
    ...
    ...(user?.plan !== 'enterprise' ? [{ path: '/pricing', icon: Zap, label: 'Upgrade' }] : []),
  ]
