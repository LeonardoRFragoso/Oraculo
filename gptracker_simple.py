...
Sem a chave da OpenAI, não posso processar suas perguntas.
                    ...
                    relevant_docs = st.session_state.llm_manager.search_relevant_documents(user_input, top_k=5)
                    ...
                    system_prompt = f"""Você é o GPTRACKER, assistente especializado em dados comerciais da Itracker.

IMPORTANTE: Use APENAS os dados fornecidos abaixo para responder. Se não houver dados relevantes, informe que precisa de mais dados específicos.

Dados disponíveis:{knowledge_context}

Responda de forma objetiva e específica baseado nos dados acima."""
